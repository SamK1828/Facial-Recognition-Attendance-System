...
class Login:
    def __init__(self,root):
        ...
        #entry1 
        self.txtuser=ttk.Entry(frame1,font=("times new roman",15,"bold"),textvariable=self.var_user)
        ...
        #entry2 
        self.txtpwd=ttk.Entry(frame1,font=("times new roman",15,"bold"),textvariable=self.var_pwd)
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            if row==None:
                ...
                open_min=messagebox.askyesno("Yes No","Access only Admin")
                if open_min>0:
                    self.var_user.set("")
                    self.var_pwd.set("")
                    self.new_window=Toplevel(self.root)
